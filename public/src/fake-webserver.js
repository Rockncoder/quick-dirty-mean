System.register(['angular2/core', 'angular2/http', 'angular2/http/testing', 'rxjs/Rx'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, http_1, testing_1;
    var quizList, FakeWebServer;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
                ...
                function FakeWebServer(backend) {
                    ...
                    this.backend.connections.subscribe(function (c) {
                        ...
                        if (c.request.url === "api/quizzes" && c.request.method === 0) {
                            ...
                            var matches = quizList.filter(function (t) {
...
//# sourceMappingURL=fake-webserver.js.map